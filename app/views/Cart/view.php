                    ...
                    <?php if (!empty($_SESSION['cart'])):?>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <?php foreach ($_SESSION['cart'] as $id => $item): ?>
                                    <tr>
                                        ...
                                        class="glyphicon glyphicon-remove text-danger del-item" aria-hidden="true"></span></a></td>
                                    </tr>
                                <?php endforeach; ?>
                                    <tr>
                                        <td>Итого:</td>
                        ...
                        <div class="col-md-6 account-left">
                            ...
                            <form method="post" action="cart/checkout" role="form" data-toggle="validator">
                                <?php if (!isset($_SESSION['user'])): ?>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="password" name="password" class="form-control" id="password" placeholder="Password"
                                              ...
                                              data-minlength="6" data-error="Парол должен включать не менее 6 символов" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                ...
                                <button type="submit" class="btn btn-default">Оформит</button>
                            </form>
